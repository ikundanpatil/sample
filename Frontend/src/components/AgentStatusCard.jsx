...
const AgentStatusCard = () => {
  ...
  return (
    <div className="w-full bg-[#161616] border border-zinc-800 rounded-[14px] p-5 shadow-xl flex flex-col gap-4">
      {/* Header */}
      ...
      <div className="space-y-3 relative before:absolute before:left-4.75 before:top-3 before:bottom-3 before:w-[2px] before:bg-zinc-800">
        {liveSteps.map((step) => {
