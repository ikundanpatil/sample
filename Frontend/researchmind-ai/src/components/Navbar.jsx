...
import { Search, Bell, Sparkles, ChevronDown, User, LogOut, Settings as SettingsIcon, Menu, Brain } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <header className="h-16 bg-[#09090B] border-b border-zinc-800 px-4 md:px-6 flex items-center justify-between sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3 w-full max-w-md">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full bg-[#18181B] border border-zinc-800 rounded-[14px] pl-10 pr-4 py-2 text-xs md:text-sm text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-white focus:ring-1 focus:ring-white/30 transition-all"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        {/* User Profile Menu with Profile Logo Icon (No photo) */}
        <div className="relative">
          <button
